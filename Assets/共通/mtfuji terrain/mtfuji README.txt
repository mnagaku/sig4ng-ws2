...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=mtfuji&box=138.949586,35.541710,138.507987,35.182385
...
-----------
  ...
  * mtfuji Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * mtfuji Height Map (SRTM3 v4.1).png
  ...
  * mtfuji Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 12m (actual) is equal to 40m in
